...
// Default stats - these can be made dynamic later
const missionStats = [
  { value: '15K+', label: 'Lives Impacted', icon: Users, color: 'from-orange-500 to-red-500' },
  { value: '50+', label: 'Programs', icon: Award, color: 'from-blue-500 to-cyan-500' },
  { value: '125+', label: 'Communities', icon: Globe, color: 'from-green-500 to-emerald-500' },
...
export default function MissionSection({ data }: MissionSectionProps) {
  ...
  const description =
    data?.description || 'We work to connect spirituality with practical life development for real-world success.';
  ...
  const imageUrl = data?.image_url || '/images/gallery/28.jpg';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <span className="text-orange-500 font-semibold tracking-wide uppercase text-sm">Our Mission</span>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-2 mb-4">
              {title}
            </h2>
