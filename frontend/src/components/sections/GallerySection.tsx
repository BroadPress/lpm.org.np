...
const defaultImages: GalleryImage[] = [
  { src: '/images/gallery/1.jpg', title: 'Village people' },
  { src: '/images/gallery/2.jpg', title: 'Donation campaign' },
  { src: '/images/gallery/3.jpg', title: 'Charity donation' },
  { src: '/images/gallery/4.jpg', title: 'Clean campaign' },
  { src: '/images/gallery/5.jpg', title: 'Happy child' },
  { src: '/images/gallery/6.jpg', title: 'Poor children' },
  { src: '/images/gallery/7.jpg', title: 'Helpless People' },
  { src: '/images/gallery/8.jpg', title: 'Volunteer team' },
];
...
export default function GallerySection({ data }: GallerySectionProps) {
  ...
  const subtitle = data?.subtitle || 'Portfolio / Gallery';
  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {images.map((item, idx) => (
            <GalleryItem key={idx} img={item.src} title={item.title} index={idx} />
          ))}
        </div>
      </div>
    </section>
