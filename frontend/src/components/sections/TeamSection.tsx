...
//           <span className="text-orange-500 font-semibold tracking-wide uppercase">Power of Positive Energy</span>
//           <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mt-2">Volunteer of the Year</h2>
//         </motion.div>
...
//           <Link href="/team" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white rounded-xl font-semibold">
