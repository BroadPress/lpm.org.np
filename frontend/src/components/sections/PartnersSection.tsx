  ...
  return (
    <section className="py-12 bg-gray-50 dark:bg-gray-900 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Our Trusted Partners</h3>
          <p className="text-gray-600 dark:text-gray-400 mt-2">Working together for a better world</p>
        </motion.div>
      ...
      {/* Keyframe injected via style tag — works in Next.js App Router */}
      <style>{`
        @keyframes marquee {
