...
//     desc: 'Life Positive Mission integrates spirituality, life coaching, and leadership development to create real transformation.', 
...
//     desc: 'Life Positive Mission is a global human development initiative focused on positive energy and life transformation.', 
...
//     desc: 'Partner with us to create a positive, conscious, and spiritually awakened world.', 
...
//         >
//           <span className="text-orange-500 font-semibold tracking-wide uppercase">Get Involve Now</span>
...
//             >
//               <div className={`w-14 h-14 rounded-xl bg-gradient-to-r ${item.color} flex items-center justify-center mb-5 shadow-lg group-hover:scale-110 transition-transform`}>
...
// src/components/sections/GetInvolvedSection.tsx
'use client';
