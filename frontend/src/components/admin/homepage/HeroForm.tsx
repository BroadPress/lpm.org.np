// src/components/admin/homepage/HeroForm.tsx
'use client';
...
const HeroForm = memo(function HeroForm({ sectionKey, initialData }: HeroFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm space-y-6 max-w-4xl">
      <div className="border-b border-gray-200 pb-4">
        <h3 className="text-lg font-semibold text-orange-600">Hero Section</h3>
        <p className="text-sm text-gray-500 mt-1">Edit hero section content</p>
      </div>
        ...
        {formData.image_url ? (
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              ...
              <label className="px-3 py-1.5 bg-blue-500 text-white rounded-lg text-sm hover:bg-blue-600 cursor-pointer">
                Change
      ...
      <div className="flex gap-3 pt-4 border-t border-gray-200">
        ...
        <button type="button" onClick={() => router.push('/admin/homepage')} className="bg-gray-200 text-gray-700 px-6 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-300">
          <X size={16} /> Cancel
        </button>
      </div>
    </form>
