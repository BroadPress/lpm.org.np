          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <div className="flex gap-4 my-2"><Clock size={14} />{featuredEvents[0].time}<MapPin size={14} />{featuredEvents[0].location}</div>
          ...
          <div className="lg:col-span-7 space-y-4">
            {firstRowEvents.map((event, idx) => (
              <div key={idx} className="bg-white rounded-xl shadow flex flex-col sm:flex-row">
                ...
                <div className="flex-1 p-5"><h3 className="text-lg font-bold">{event.title}</h3><div className="flex gap-3 text-sm text-gray-500 my-1"><Clock size={14} />{event.time}<MapPin size={14} />{event.location}</div><p className="text-gray-600 text-sm">{event.desc}</p></div>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <div className="flex gap-4 my-2"><Clock size={14} />{featuredEvents[1].time}<MapPin size={14} />{featuredEvents[1].location}</div>
