...
const listEvents = [
  { date: { day: '20th', month: 'AUG' }, title: 'Youth Empowerment Workshop', time: '10:00 am - 4:00 pm', location: 'LPM Training Hall, Kathmandu', desc: 'A workshop focused on developing leadership skills, positive mindset, and career guidance for the youth of Nepal.' },
  { date: { day: '25th', month: 'AUG' }, title: 'Spiritual Awakening Program', time: '6:00 am - 9:00 am', location: 'Pashupatinath Temple Area', desc: 'Discover the power of positive energy and spiritual growth through our guided meditation and mindfulness sessions.' },
  { date: { day: '10th', month: 'SEP' }, title: 'Entrepreneurship Development Meet', time: '1:00 pm - 5:00 pm', location: 'Kathmandu University Hall', desc: 'Connecting aspiring entrepreneurs with mentors to foster innovation and business growth in local communities.' },
  { date: { day: '15th', month: 'SEP' }, title: 'Leadership Training for Youth', time: '8:00 am - 12:30 pm', location: 'LPM Training Center', desc: 'A transformational program focused on self-management, positive thinking, and communication skills to develop future leaders.' },
  { date: { day: '22nd', month: 'SEP' }, title: 'Traffic Awareness Campaign', time: '10:00 am - 2:00 pm', location: 'Major Intersections', desc: 'A public initiative to educate citizens about road safety and traffic discipline in collaboration with local authorities.' },
  { date: { day: '5th', month: 'OCT' }, title: 'Cultural Harmony Meet', time: '4:00 pm - 7:00 pm', location: 'Nepal-India Friendship Hall', desc: 'Promoting human connection and cultural understanding through spiritual and social exchange programs.' }
];

const featuredEvents = [
  { side: 'left', date: { day: '15th', month: 'AUG' }, title: 'Self Management Leadership', time: '8:00 am - 12:30 pm', location: 'Ananda Pashupati Dharmashala', desc: 'It is widely used in youth development, entrepreneurship, and organizational growth because it creates responsible individuals who can lead by example.', image: '/events/1.jpg' },
  { side: 'right', date: { day: '12th', month: 'OCT' }, title: 'Join our mission! Learn about our upcoming projects and how you can contribute to social transformation.', image: '/events/2.jpg' }
];
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-12">
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden h-[500px]">
              ...
              <div className="absolute top-4 left-4 bg-gradient-to-r from-orange-500 to-pink-500 rounded-xl px-4 py-2">
                <h4 className="text-white font-bold">15th</h4><h5 className="text-white text-sm">AUG</h5>
                </div>
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <div className="flex items-center gap-2 my-2">
                  ...
                  <MapPin size={14} /><span>{featuredEvents[0].location}</span>
                  </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            {firstRowEvents.map((event, idx) => (
              <div key={idx} className="mt-6 bg-white rounded-2xl shadow-lg flex flex-col sm:flex-row">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-2xl overflow-hidden h-[500px]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                ...
                <div className="flex items-center gap-2 my-2">
                  <Clock size={14} /><span>{featuredEvents[1].time}</span><MapPin size={14} /><span>{featuredEvents[1].location}</span></div>
